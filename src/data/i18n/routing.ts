...
export const localizedSlugs: Record<PageId, Record<LocaleCode, string>> = {
	...
	'eac-bypass': {
		en: 'eac-bypass-rust',
		es: 'eac-bypass-rust-trucos',
		fr: 'eac-bypass-rust-triche',
		de: 'eac-bypass-rust',
		pt: 'eac-bypass-rust-cheats',
		it: 'eac-bypass-rust-trucchi',
		nl: 'eac-bypass-rust',
		pl: 'eac-bypass-rust-cheatow',
		ru: 'eac-bypass-rust-chity',
		tr: 'eac-bypass-rust',
		ar: 'eac-bypass-rust',
		ja: 'eac-bypass-rust',
		ko: 'eac-bypass-rust',
		...
		th: 'eac-bypass-rust',
		vi: 'eac-bypass-rust',
		uk: 'eac-bypass-rust-chity',
		cs: 'eac-bypass-rust',
		ro: 'eac-bypass-rust-cheats',
		sv: 'eac-bypass-rust',
	},
	'cheats-2026': {
		en: 'rust-cheats-2026',
