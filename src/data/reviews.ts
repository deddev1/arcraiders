...
const reviewOgImage = {
	...
	title: 'Arc Raiders Hacks customer reviews',
	caption: 'Arc Raiders Hacks buyer reviews for ESP soft aim, radar, and cloud DMA',
};
			...
			images: [
				{
					...
					title: `Arc Raiders Hacks review by @${review.handle}`,
