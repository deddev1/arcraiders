...
export const blogPosts: BlogPostDefinition[] = [
	{
		...
		metaDescription: "Plain-English Fortnite patch notes guide — how buffs, nerfs, and vaults reshape loadouts in Chapter 7 Season 3. Read, then adapt ranked priorities.",
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					"On big update mornings, confirm <a href=\"https://status.epicgames.com/\" target=\"_blank\" rel=\"noopener noreferrer\">Epic Games Status</a> is healthy before blaming your settings. If you also use information tools in-match, check <a href=\"/updates/\">Fortnite Cheats Updates</a> after Easy Anti-Cheat patches.",
