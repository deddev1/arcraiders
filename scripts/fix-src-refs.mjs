...
const REPLACEMENTS = [
	...
	['/undetected-warzone-cheats/', '/arc-raiders-hacks/'],
	['/warzone-wallhack/', '/arc-raiders-wallhack/'],
	['/warzone-radar-hack/', '/arc-raiders-radar/'],
	['/ricochet-bypass/', '/arc-raiders-hacks/'],
	['/warzone-cheats-2026/', '/arc-raiders-hacks/'],
	['/warzone-aimbot/', '/arc-raiders-aimbot/'],
	['/warzone-esp/', '/arc-raiders-esp/'],
	['/warzone-hacks/', '/arc-raiders-esp/'],
