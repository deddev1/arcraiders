...
function buildLegal(locale, pageKey, kind) {
	...
	return {
		title: clampTitle(stripZadeyoFromMeta(`${h1} | Fortnite Hacks`)),
		description: clampDesc(stripZadeyoFromMeta(`${h1} for Fortnite Hacks — ESP wallhack, Aimbot, ${p.win}.`)),
		h1,
		intro: p.s1(`${h1} for fortnitehack.net and Fortnite licenses.`),
		...
		sections: [
			section(
				...
				kind === 'privacy' ? 'Payment details are processed by Zadeyo checkout — not stored on fortnitehack.net.' : p.s2(),
			),
			section(
