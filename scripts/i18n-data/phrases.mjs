...
export const phrases = {
	es: {
		buy: 'Comprar Arc Raiders Hacks', undetected: 'indetectables', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'Contacta support@arcraidershacks.com para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Arc Raiders Hacks', undetected: 'indétectables', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'Contactez support@arcraidershacks.com pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Arc Raiders Hacks kaufen', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Arc Raiders Hacks', undetected: 'indetectáveis', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'Contacte support@arcraidershacks.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Arc Raiders Hacks', undetected: 'indetectable', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'Contatta support@arcraidershacks.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'Arc Raiders Hacks kopen', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Arc Raiders Hacks satın al', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'Destek ve yasal sorular için support@arcraidershacks.com.',
	},
	ar: {
		buy: 'اشترِ Arc Raiders Hacks', undetected: 'غير مكتشف', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Arc Raiders Hacksを購入', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'サポート・法務: support@arcraidershacks.com',
	},
	ko: {
		buy: 'Arc Raiders Hacks 구매', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => '지원 및 법무: support@arcraidershacks.com',
	},
	zh: {
		buy: '购买 Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => '支持与法务：support@arcraidershacks.com',
	},
	hi: {
		buy: 'Arc Raiders Hacks खरीदें', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'सहायता: support@arcraidershacks.com',
	},
	id: {
		buy: 'Beli Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, oil rigs, and wipe-cycle raids',
		...
		legal: () => 'support@arcraidershacks.com för support och juridik.',
	},
};
