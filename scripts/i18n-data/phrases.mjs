...
export const phrases = {
	es: {
		buy: 'Comprar Arc Raiders Hacks', undetected: 'indetectables', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'Contacta support@arcraidershacks.net para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Arc Raiders Hacks', undetected: 'indétectables', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'Contactez support@arcraidershacks.net pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Arc Raiders Hacks kaufen', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Arc Raiders Hacks', undetected: 'indetectáveis', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'Contacte support@arcraidershacks.net para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Arc Raiders Hacks', undetected: 'indetectable', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'Contatta support@arcraidershacks.net per supporto o richieste legali.',
	},
	nl: {
		buy: 'Arc Raiders Hacks kopen', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Arc Raiders Hacks satın al', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'Destek ve yasal sorular için support@arcraidershacks.net.',
	},
	ar: {
		buy: 'اشترِ Arc Raiders Hacks', undetected: 'غير مكتشف', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Arc Raiders Hacksを購入', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'サポート・法務: support@arcraidershacks.net',
	},
	ko: {
		buy: 'Arc Raiders Hacks 구매', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => '지원 및 법무: support@arcraidershacks.net',
	},
	zh: {
		buy: '购买 Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => '支持与法务：support@arcraidershacks.net',
	},
	hi: {
		buy: 'Arc Raiders Hacks खरीदें', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'सहायता: support@arcraidershacks.net',
	},
	id: {
		buy: 'Beli Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Arc Raiders Hacks', undetected: 'undetected', maps: 'extraction zones, ARC patrol routes, and collapsed districts',
		...
		legal: () => 'support@arcraidershacks.net för support och juridik.',
	},
};
